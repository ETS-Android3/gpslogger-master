...
public class GpsLoggingService extends Service {
    ...
    public void onCreate() {
        spp = getSharedPreferences("MYUserPref", MODE_PRIVATE);
    ...
    public void req() {
        ...
        RequestBody body = RequestBody.create(mediaType, "{\"id\": \"omid\", \"lat\":" + latitude + ", \"long\":"+longitude+"}");
        Request request = new Request.Builder()
                .url("http://192.168.1.162:5050/add")
                .method("POST", body)
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                Log.i("onFailure", "onFailure: eshteb shod");
            }

            @Override
            public void onResponse(Call call, Response response) {
//                try {
//                    License license = new Gson().fromJson(response.body().string(), License.class);
//                    System.out.println(license);
//
//                    if (license.isResultKey() == true) {
//
//
//                        Log.i("respon", "miyad ??????");
//                    } else if (license.isResultKey() == false) {
//                        value = false;
//
//
//                    }
...
//                    Log.i("", "");
//                }
                Log.i("onResponse", "onResponse: dorost shod");
            }
