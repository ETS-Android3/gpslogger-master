...
//            populateProfilesList();
    ...
    public void showD() {
        ...
        btn_cancle = mView.findViewById(R.id.cancle);
        btn_ok = mView.findViewById(R.id.ok);
        alert.setView(mView);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                showText.setText(text_input.getText().toString());

                nameStr = text_input.getText().toString();
